...
r =requests.post('http://183.129.255.162:81/web/api/login',headers=headers,json={"a":"190473","b":"15755315230"})
...
r_sign_in = requests.post('http://183.129.255.162:81/web/api/employee/fill',headers=headers,cookies=cookies,json=payload)
